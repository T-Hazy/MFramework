...
using System.IO;
using MFramework.EditorWindowExtension;
using MFramework.UtilityLibrary;
using UnityEditor;
using UnityEngine;
...
namespace MFramework
{
    public class MFrameworkWindow : EditorWindowEditor
    {
        ...
        protected void OnGUI() {
            //绘制标题
            DrawRectWithOutline(new Vector2(position.width, 80), ColorLibrary.GrayPercentage(0.2f),
        ...
        private void DrawMFrameworkPackagesContent() {
            DrawScrollView("MFramework View", () =>
            {
                ...
                this.DrawBorderedGUIContent(new GUIContent("Index"), new Vector2(50, 25), 1,
                    ColorLibrary.GrayPercentage(0.35f));
